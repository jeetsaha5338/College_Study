...
@WebServlet("/PatientDeleteAppointment")
public class PatientDeleteAppointment extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String Pemail = request.getParameter("patient");
		...
		for(PatientAppointment ob : docList)
		{
			if(Demail.equals(ob.getDemail()) && Date.equals(ob.getDate()) && Pemail.equals(ob.getPemail()))
			{
				...
				if(f)
				{
					...
					RequestDispatcher rd = request.getRequestDispatcher("PatientDeleteAppointment.jsp");
		...
		RequestDispatcher rd = request.getRequestDispatcher("PatientDeleteAppointment.jsp");// RequestDispatcher interface create connection b/w the servlet & jsp
		rd.forward(request, response);
