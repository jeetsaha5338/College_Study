...
public class DBLogic {
	...
	public static Connection getMySQLConnection() throws ClassNotFoundException,SQLException
	{
		...
		Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/jee","root","Jeet1998@");
		return con;
	}
	...
	public boolean updateData(StudentInfo ob)
	{
		boolean f = false;
		try
		{
	...
	public boolean deleteData(int ob)
	{
		boolean f = false;
		try
		{
