...
int main()
{
	...
	nd *start=NULL;
	do{	
		printf("\n\n\t\tENTER TOUR CHOISE:\n\n\tPRESS 01: ENTER NODE AT BEGINIG\n\tPRESS 02. ENTER NODE AT END\n\tPRESS 03: SEARCH\n\tPRESS 04: ENTER A NODE AFTER A GIVEN KEY\n\tPRESS 05: ENTER A NODE BEFORE A GIVEN KEY\n\tPRESS 06: DELETE NODE AT BEGINIG\n\tPRESS 07: DELETE NODE AT END\n\tPRESS 08: DELETE NODE AT ANY POSITION\n\tPRESS 10: COUNT NO.OF NODE\n\tPRESS 11: DISPLAY\n\tPRESS 12: EXIT\n\n");
		scanf("%d",&choise);
		switch(choise)
		{	
...
void node_count(nd* start)
{
	int c;
	nd* i;
	printf("\nNO. OF NODE PRESENT IS THE LINKED LIST IS:\t");
